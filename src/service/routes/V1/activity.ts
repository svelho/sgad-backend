...
createActivityRouter.post("/activity/create", async function (req, res) {
  try {
    console.log(`Create activity called by Frontend: ${req.body.id}`, req.body);
...
getActivitiesRouter.get("/activities", async function (req, res) {
  try {
...
deleteActivityRouter.delete("/activity/delete/:id", async function (req, res) {
  try {
